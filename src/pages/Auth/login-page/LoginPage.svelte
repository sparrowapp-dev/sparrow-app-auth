...
>>>>>>> Stashed changes
	...
	>
		...
		<div class="mb-4">
			<label for="exampleInputPassword1" class="form-label text-lightGray sparrow-fs-14 d-flex">Password<p class="ms-1 mb-0 sparrow-fw-600 text-dangerColor">*</p></label>
			<!-- <img src={starIcon} alt="" class="mb-3" style="width: 7px;" /> -->
